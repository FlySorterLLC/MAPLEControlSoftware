...
class santaFe:
    ...
    def homeWithdraw(self, refptX, refptY, homecoordX, homecoordY, carefulZ=9, vacBurst=1, homeZ=45):
    ...
    def homeDeposit(self, refptX, refptY, homecoordX, homecoordY, carefulZ=9, vacBurst=1, homeZ=44):
        self.moveToSpd(pt=[float(refptX), float(refptY), 0, 0, 10, 5000])       # Allgin to outermost flyhome to prevent tripping
        self.dwell(t=1)
        self.moveToSpd(pt=[float(homecoordX), float(homecoordY), 0, 0, 10, 5000])        # Go to actual home
        self.dwell(t=1)
